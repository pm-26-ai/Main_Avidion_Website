...
const Footer = () => {
  return (
    // <footer className=" pt-10 text-[#e0e0e0]">
    //   <div className="mx-auto flex max-w-6xl flex-wrap justify-around gap-6 px-4">
    //     {/* About Column */}
    //     <div className="mb-6 flex w-full flex-col sm:w-1/4">
    ...
    //           <FaEnvelope className="mr-2" /> info@avidion.ai
    //         </li>
    //         <li className="mb-2 flex items-center">
    //           <FaPhoneAlt className="mr-2" /> +91 9896584099
    //         </li>
    //         <li className="mb-2 flex items-center">
    //           <FaMapMarkerAlt className="mr-2" /> 676, Sector-42, Gurugram,
    //           Haryana, India
    //         </li>
    //       </ul>
    //     </div>
    ...
    //     {/* Navigation Column */}
    //     <div className="mb-6 w-full sm:w-1/4">
    //       <h3 className="mb-4 pb-2 text-xl text-white">Navigation</h3>
    //       <ul>
    //         <li>
    //           <a
    //             href="#"
    //             className="mb-2 text-sm text-[#b0b0b0] hover:text-white hover:underline"
    //           >
    //             Home
    //           </a>
    //         </li>
    ...
    //     {/* Services Column */}
    //     <div className="mb-6 w-full sm:w-1/4">
    //       <h3 className="mb-4 pb-2 text-xl text-white">Services</h3>
    //       <ul>
    //         <li>
    //           <a
    //             href="#"
    ...
    //     {/* Connect Column */}
    //     <div className="mb-6 w-full sm:w-1/4">
    //       <h3 className="mb-4 pb-2 text-xl text-white">Connect</h3>
    //       <ul className="flex flex-wrap gap-4">
    //         <li>
    //           <a
    //             href="#"
    //             aria-label="LinkedIn"
    //             className="text-xl text-[#b0b0b0] hover:text-white"
    //           >
    //             <FaLinkedinIn />
    //           </a>
    //         </li>
    ...
    //   <div className="mt-6 bg-gradient-to-r from-[#2c004e] to-[#580082] py-5 text-center">
    //     <p className="text-sm text-[#e0e0e0]">
    //       &copy; 2025 Avidion. All rights reserved.
    //     </p>
    //   </div>
    // </footer>
    <>
